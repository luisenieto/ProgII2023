    ...
    */
    ...
    public void btnGuardarClic(ActionEvent evt) {
        ...
        if (this.amProducto == null) { //creación            
            resultado = gp.crearProducto(this.usuarioLogueado, codigo, descripcion, precio, categoria, estado);
            ...
            resultado = gp.modificarProducto(this.usuarioLogueado, this.amProducto, codigo, descripcion, precio, categoria, estado);
            if (!resultado.equals(IGestorProductos.EXITO))
                JOptionPane.showMessageDialog(null, resultado, TITULO_NUEVO, JOptionPane.ERROR_MESSAGE);
            else
                this.ventana.dispose();
